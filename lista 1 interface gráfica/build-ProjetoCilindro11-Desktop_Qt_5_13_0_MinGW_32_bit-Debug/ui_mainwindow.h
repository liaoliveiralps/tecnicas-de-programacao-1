...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_3->setGeometry(QRect(20, 133, 111, 20));
        QFont font;
        ...
        textEditResultado->setGeometry(QRect(20, 160, 361, 81));
        pushButton = new QPushButton(centralWidget);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));
        pushButton->setGeometry(QRect(140, 102, 71, 21));
        QFont font1;
        ...
        widget1->setGeometry(QRect(20, 60, 141, 29));
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "PROJETO CILINDRO", nullptr));
