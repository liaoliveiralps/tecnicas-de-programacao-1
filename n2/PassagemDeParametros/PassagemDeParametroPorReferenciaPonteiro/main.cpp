...
public:
    static void trocaPPR(int *a, int *b){
        ...
        cout<<"Conteúdo de a = "<<a<<"      Conteúdo de b = "<<b<<endl;
...
int main(void){
    ...
    cout<<"Conteudo Valor 1 = "<<valor1<< " Endereco Valor 1 = "<<&valor1<<endl;
    cout<<"Conteudo Valor 2 = "<<valor2<< " Endereco Valor 2 = "<<&valor2<<endl<<endl;
